...
(function($PS) {
  ...
  var exports = $PS["Presto.Core.Utils.Encoding"];
...
(function($PS) {
  ...
  var exports = $PS["Presto.Core.Types.API"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Foreign_Class = $PS["Foreign.Class"];
  var Foreign_Generic_Class = $PS["Foreign.Generic.Class"];
...
(function($PS) {
  ...
  var exports = $PS["Presto.Core.Types.Language.Interaction"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Control_Monad_Except = $PS["Control.Monad.Except"];
...
(function($PS) {
  ...
  var exports = $PS["Presto.Core.Language.Runtime.API"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Error_Class = $PS["Control.Monad.Error.Class"];
  var Control_Monad_Except = $PS["Control.Monad.Except"];
...
(function($PS) {
  ...
  "use strict";
  $PS["Presto.Core.LocalStorage"] = $PS["Presto.Core.LocalStorage"] || {};
  var exports = $PS["Presto.Core.LocalStorage"];
  ...
  var deleteValueFromLocalStore = function (k) {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function () {
          return $foreign.deleteValueFromLocalStoreImpl(k);
      });
  };
  exports["getValueFromLocalStore"] = getValueFromLocalStore;
  exports["setValueToLocalStore"] = setValueToLocalStore;
  exports["deleteValueFromLocalStore"] = deleteValueFromLocalStore;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Presto.Core.Types.Language.Flow"] = $PS["Presto.Core.Types.Language.Flow"] || {};
  var exports = $PS["Presto.Core.Types.Language.Flow"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Control_Monad_Free = $PS["Control.Monad.Free"];
  ...
  var Delete = (function () {
      function Delete(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Delete.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Delete(value0, value1, value2);
              };
          };
      };
      return Delete;
...
(function($PS) {
  ...
  var exports = $PS["Presto.Core.Language.Runtime.Interpreter"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Error_Class = $PS["Control.Monad.Error.Class"];
  ...
  var readState = Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Effect_Aff.monadAff)))(function ($98) {
      return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(Effect_Aff_AVar.read($98));
  });
  ...
  var interpret = function (v) {
      return function (v1) {
          if (v1 instanceof Presto_Core_Types_Language_Flow.CallAPI) {
              return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Presto_Core_Language_Runtime_API.runAPIInteraction(v.value2)(v1.value0))(function ($99) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1.value1($99));
              }));
          };
          if (v1 instanceof Presto_Core_Types_Language_Flow.RunUI) {
              return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(runUIInteraction(v.value0)(v1.value0))(function ($100) {
          ...
          if (v1 instanceof Presto_Core_Types_Language_Flow.Get && v1.value0 instanceof Presto_Core_Types_Language_Flow.LocalStore) {
              return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Presto_Core_LocalStorage.getValueFromLocalStore(v1.value1))(function ($101) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1.value2($101));
              }));
          };
          if (v1 instanceof Presto_Core_Types_Language_Flow.Get && v1.value0 instanceof Presto_Core_Types_Language_Flow.InMemoryStore) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(readState)(function ($102) {
                  return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Effect_Aff.monadAff))(v1.value2(Foreign_Object.lookup(v1.value1)($102)));
              });
          };
          ...
          if (v1 instanceof Presto_Core_Types_Language_Flow.Delete && v1.value0 instanceof Presto_Core_Types_Language_Flow.LocalStore) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(Presto_Core_LocalStorage.deleteValueFromLocalStore(v1.value1)))(function () {
                  return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Effect_Aff.monadAff))(v1.value2);
              });
          };
          if (v1 instanceof Presto_Core_Types_Language_Flow.Delete && v1.value0 instanceof Presto_Core_Types_Language_Flow.InMemoryStore) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(Data_Functor.map(Control_Monad_State_Trans.functorStateT(Effect_Aff.functorAff))(Foreign_Object["delete"](v1.value1))(readState))(function (v2) {
                  return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Effect_Aff.monadAff))(v1.value2);
              });
          };
          if (v1 instanceof Presto_Core_Types_Language_Flow.Fork) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(forkFlow(v)(v1.value0))(function ($103) {
                  return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Effect_Aff.monadAff))(v1.value1($103));
              });
          };
          if (v1 instanceof Presto_Core_Types_Language_Flow.DoAff) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(v1.value0))(function ($104) {
          ...
          if (v1 instanceof Presto_Core_Types_Language_Flow.Await) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(Effect_Aff_AVar.read(v1.value0)))(function ($105) {
          ...
          if (v1 instanceof Presto_Core_Types_Language_Flow.HandleError) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Effect_Aff.monadAff))(run(v)(v1.value0))(runErrorHandler))(function ($106) {
          ...
          if (v1 instanceof Presto_Core_Types_Language_Flow.CheckPermissions) {
              return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(v.value1.value0(v1.value0))(function ($107) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1.value1($107));
              }));
          };
          if (v1 instanceof Presto_Core_Types_Language_Flow.TakePermissions) {
              return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(v.value1.value1(v1.value0))(function ($108) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1.value1($108));
              }));
          };
...
(function($PS) {
  ...
  var exports = $PS["Presto.Core.Types.Permission"];                       
...
(function($PS) {
  ...
  var genericCounterScreenAction = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Increment) {
          return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
      };
      if (x instanceof Decrement) {
          return new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value);
      };
      throw new Error("Failed pattern match at Main (line 68, column 8 - line 68, column 76): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var decodeCounterScreenAction = new Foreign_Class.Decode(Foreign_Generic.genericDecode(genericCounterScreenAction)(Foreign_Generic_Class.genericDecodeSum(Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Increment";
  }))(Foreign_Generic_Class.genericDecodeArgsNoArguments)(Foreign_Generic_Class.genericCountArgsNoArguments))(Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Decrement";
  }))(Foreign_Generic_Class.genericDecodeArgsNoArguments)(Foreign_Generic_Class.genericCountArgsNoArguments)))({
  ...
  var count = function (val) {
      return Control_Bind.bind(Control_Monad_Free.freeBind)(Presto_Core_Types_Language_Flow.runUI(counterScreenInteract)(new CounterScreen(val)))(function (v) {
          var val$prime = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 27, column 14 - line 30, column 3): " + [ v.constructor.name ]);
          })();
          return count(val$prime);
      });
  };
  ...
  var launchApp = (function () {
      var uiRunner = function (a) {
          return Effect_Aff.makeAff(function (callback) {
              return Control_Apply.applySecond(Effect.applyEffect)($foreign["showUI'"](function ($15) {
                  return callback(Data_Either.Right.create($15));
